...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.raccoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.raccointools.com");
        vSeeds.emplace_back("dnsseed.raccoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.raccointools.com");
        vSeeds.emplace_back("seed-b.raccoin.loshan.co.uk");
