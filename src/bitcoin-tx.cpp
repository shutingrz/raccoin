...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s raccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  raccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded raccoin transaction") + "\n" +
              "  raccoin-tx [options] -create [commands]   " + _("Create hex-encoded raccoin transaction") + "\n" +
              "\n";
