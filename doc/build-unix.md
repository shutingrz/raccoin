UNIX BUILD NOTES
====================
Some notes on how to build Raccoin Core in Unix.
...
memory available when compiling Raccoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Raccoin Core without wallet.
...
If you want to build Raccoin-Qt, make sure that the required packages for Qt development
...
As mentioned above, when maintaining portability of the wallet between the standard Raccoin Core distributions and independently built
