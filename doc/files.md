...
* raccoin.conf: contains configuration settings for raccoind or raccoin-qt
* raccoind.pid: stores the process id of raccoind while running
...
* debug.log: contains debug information and general logging generated by raccoind or raccoin-qt
