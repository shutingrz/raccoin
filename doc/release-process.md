...
### Build and sign Raccoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.ltc/ ../raccoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.ltc/ ../raccoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.ltc/ ../raccoin/contrib/gitian-descriptors/gitian-osx.yml
...
Create (and optionally verify) the signed OS X binary:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.ltc/ ../raccoin/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.ltc/ ../raccoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-win-signed ../raccoin/contrib/gitian-descriptors/gitian-win-signer.yml
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the raccoin.org server.
